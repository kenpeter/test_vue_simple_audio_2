    ...
    <img class="player__cover" :src="currentTrack.cover.large" alt="" />
      ...
      <div class="player__timer">
        ...
        <ul class="player__controls">
          <!-- li -->
          <!-- control small -->
          <!-- vbind:class,  control--active, player.repeat -->
          <!-- vbind:class control--dimmed,  !player.repeat -->
          <!-- @click toggle repeat -->
          <li
